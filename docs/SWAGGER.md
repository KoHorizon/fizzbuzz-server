...
### Option 1: Browse on GitHub (No Installation)

Simply view the `docs/swagger.yaml` file on GitHub. GitHub renders YAML files with syntax highlighting, making it easy to read the API specification.

### Option 2: Online Swagger Editor (No Installation)
...
The Swagger Editor provides:
- **Interactive API explorer** - Try out API endpoints
...
### Option 3: Serve Locally with Swagger UI
